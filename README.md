...
- API version: 3.0.0-beta.1
  - Build date: 2022-10-20T11:04:19.015422-07:00[America/Los_Angeles]
...
```groovy
  ...
  dependencies {
     implementation "com.onelogin:onelogin-java-sdk:3.0.0-beta.1"
  }
```
...
* `target/onelogin-java-sdk-3.0.0-beta.1.jar`
* `target/lib/*.jar`
