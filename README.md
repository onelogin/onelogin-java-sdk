...
- API version: 3.0.0-alpha.1
  - Build date: 2022-08-10T13:08:46.841766-07:00[America/Los_Angeles]
...
```groovy
  ...
  dependencies {
     implementation "com.onelogin:openapi-java-client:3.0.0-alpha.1"
  }
```
...
* `target/openapi-java-client-3.0.0-alpha.1.jar`
* `target/lib/*.jar`
