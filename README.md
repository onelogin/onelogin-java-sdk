...
```groovy
  ...
  dependencies {
     implementation "com.onelogin:onelogin-java-sdk:3.1.0"
  }
```
...
* `target/onelogin-java-sdk-3.1.0.jar`
* `target/lib/*.jar`
...
*DefaultApi* | [**listActionValues**](docs/DefaultApi.md#listActionValues) | **GET** /api/2/apps/{app_id}/rules/actions/{action_value}/values | 
...
*DefaultApi* | [**listMappingActionValues**](docs/DefaultApi.md#listMappingActionValues) | **GET** /api/2/apps/mappings/actions/{action_value}/values | 
