...
public class TestClientSettings {
        ...
        public void testFileSettings()
                        throws IOException, Error, OAuthSystemException, OAuthProblemException, URISyntaxException {
        ...
        public void testInvalidSettings() throws IOException, Error, OAuthSystemException, OAuthProblemException,
                        URISyntaxException, ErrorResourceInitialization {
                Settings settings = new Settings();
        ...
        @Test
        public void testGetApiConfigurationDefaultCase()
                        throws IOException, Error, OAuthSystemException, OAuthProblemException, URISyntaxException {
                Settings settings = new Settings();
        ...
        @Test
        public void testGetApiConfigurationModifiedApiConfigClient()
                        throws IOException, Error, OAuthSystemException, OAuthProblemException, URISyntaxException {
        ...
        @Test
        public void testGetApiConfigurationModifiedApiConfigMethod()
                        throws IOException, Error, OAuthSystemException, OAuthProblemException, URISyntaxException {
                Map<String, Integer> newApiConfiguration = new HashMap<String, Integer>();
                newApiConfiguration.put("role", 1);
                newApiConfiguration.put("user", 1);
