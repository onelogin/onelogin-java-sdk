...
public class RuleCondition {
  ...
  public RuleCondition name(String name) {
  ...
  **/
  ...
  public RuleCondition value(String value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, ruleCondition.name) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to RuleCondition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RuleCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RuleCondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleCondition` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
