...
public class RuleAction {
  ...
  **/
  ...
  public RuleAction value(String value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, ruleAction.name) &&
        Objects.equals(this.value, ruleAction.value);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RuleAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RuleAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RuleAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleAction` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
